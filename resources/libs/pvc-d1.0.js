...
pvc.AxisPanel = pvc.BasePanel.extend({
    ...
    getTextLength: function(text, font){
      ...
      switch(pv.renderer()){
        case 'batik':
            return this.getTextLenCGG(text, font);
        case 'vml':
    ...
    getTextLenCGG: function(text, font){
     // // return 2;//TODO:hcoded
     // if(text == '') return 0;
     //   var holder = this.getTextSizePlaceholderCGG();
     // 
     //   //var panel = new pv.Panel();
     //   //panel.canvas(this.chart.options.canvas + '_textSizeHtmlObj');
     //   //var lbl = panel.add(pv.Label).text(text);
     //   //if(font){
     //   //    lbl.font(font);
     //   //}
     //   //lbl.render();
     //   ////get generated label
     //   //var box = holder.getBBox();//bounding box
     //   //return box.width;
     //   
     // //  
     // //var holder = this.getTextSizePlaceholderCGG();
     ...
     //// var box = txtEl.getBBox();
     // //var box2 = txt.getBBox();
     // //var len = box == null ? holder.width:
      
      return 5;
      
    //  var len = txtEl.getComputedTextLength();
    //  //var len = box == null? txtEl.getComputedTextLength() : box.width;
    ////  holder.removeChild(holder.lastChild);
    ////   print('text=' + text + '  len=' + len + ' wtf' + len.getUnderlyingValue);
    //   //for(var i in len){
    //   // print(i);
    //   //}
    //   
    ...
    {    
      ...
      //  print('fitInfo: ' + fitInfo.h +', ' + fitInfo.v + ', ' + fitInfo.d);
