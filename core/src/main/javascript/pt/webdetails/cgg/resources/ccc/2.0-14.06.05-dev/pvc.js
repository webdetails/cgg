...
define([ "./def", "./protovis", "jquery", "./tipsy" ], function(def, pv, $) {
    ...
    function numForm_buildFormatSectionPosNeg(section) {
        function numFormRt_formatSectionPosNeg(style, value, zeroFormat, negativeMode) {
            ...
            scale && (value = pvc.mult10(value, scale));
    ...
    }), numFormStyle = pvc.numberFormatStyle = function(other, proto) {
        return new NumFormStyle(other, proto);
    }, numForm_sharedProp = def.shared().property("safe");
    pvc.NumberFormatStyle = NumFormStyle;
    def.classAccessors(NumFormStyle, numForm_sharedProp, {
        decimal: {
            cast: String,
            fail: def.falsy
        },
    ...
    def.copyOwn(NumFormStyle.prototype, {
    ...
    var numForm = pvc.numberFormat = function() {
        ...
        fields = def.instance(numFormat, numForm, numForm_sharedProp, arguments, {
            mask: {
                cast: String,
                change: function() {
                    formatter = null;
    ...
    var numForm_cache = {}, numForm_cacheCount = 0, dateForm = pvc.dateFormat = function() {
        ...
        fields = def.instance(dateFormat, dateForm, numForm_sharedProp, arguments, {
            mask: {
                cast: String,
                change: function() {
                    formatter = null;
    ...
    var customForm = pvc.customFormat = function() {
        ...
        fields = def.instance(customFormat, customForm, numForm_sharedProp, arguments, {
            formatter: {
                cast: def.fun.as
            }
        });
    ...
    var formProvider = pvc.format = function() {
        ...
        def.instance(formatProvider, formProvider, numForm_sharedProp, arguments, {
    ...
    def.type("pvc.data.DimensionType").init(function(complexType, name, keyArgs) {
        ...
        if (formatter) format = pvc.format(def.set({}, formatName, formatter), formatProto); else if (this.isDiscreteValueType) format = formProvider(null, formatProto); else {
        ...
        comparer: function(reverse) {
            ...
            var me = this;
            return reverse ? this._rc || (this._rc = function(a, b) {
                return me.compare(b, a);
            }) : this._dc || (this._dc = function(a, b) {
    ...
    def.type("pvc.BaseChart", pvc.Abstract).add(pvc.visual.Interactive).init(function(options) {
        ...
        if (parent) options || def.fail.argumentRequired("options"); else {
            ...
            pvc_initChartClassDefaults && pvc_initChartClassDefaults(defaults);
        ...
        _processFormatOption: function(options, formatProvider, formatName, optionName) {
            ...
            if (format !== pvc.format.defaults[formatName]()) options[optionName] = format; else {
        ...
        _processDataOptions: function(options) {
            if (!this.parent) {
                ...
                if (void 0 === dataSeparator) {
                    var dataOptions = options.dataOptions;
                    dataOptions && (dataSeparator = dataOptions.separator);
                }
    ...
    var pvc_initChartClassDefaults = function(defaults) {
        defaults.valueFormat || (defaults.valueFormat = formProvider.defaults.number());
        defaults.percentValueFormat || (defaults.percentValueFormat = formProvider.defaults.percent());
    ...
    pvc.BaseChart.add({
        ...
        _onLoadData: function() {
            ...
            var options = this.options, dataPartDimName = this._getDataPartDimName(), complexTypeProj = this._complexTypeProj || def.assert("Invalid state."), dimsOptions = this._createDimensionsOptions(options);
            ...
            translation && pvc.debug >= 3 && this._log(translation.logVItem());
        ...
        _createTranslationOptions: function(options, dimsOptions, dataPartDimName) {
            var dataOptions = options.dataOptions || {}, dataMeasuresInColumns = options.dataMeasuresInColumns;
            ...
            var plot2Series, plot2DataSeriesIndexes, plot2 = options.plot2;
            if (plot2) {
    ...
    def.type("pvc.BarAbstractPanel", pvc.CategoricalAbstractPanel).add({
        ...
        _buildScene: function(data, axisSeriesDatas, axisCategDatas) {
            ...
            var rootScene = new pvc.visual.Scene(null, {
                panel: this,
                source: data
            }), roles = this.visualRoles, valueVarHelper = new pvc.visual.RoleVarHelper(rootScene, roles.value, {
                roleVar: "value",
    ...
    def.type("pvc.MetricPointPanel", pvc.CartesianAbstractPanel).init(function(chart, parent, plot, options) {
        ...
        _buildScene: function() {
            ...
            var data = this.visibleData({
                ...
                panel: this,
                source: data
            }), roles = this.visualRoles, colorVarHelper = new pvc.visual.RoleVarHelper(rootScene, roles.color, {
                roleVar: "color"
            }), sizeVarHelper = new pvc.visual.RoleVarHelper(rootScene, roles.size, {
                roleVar: "size"
